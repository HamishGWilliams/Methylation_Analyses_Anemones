...
act_CHH_f = filterByCoverage(act_CHH, lo.count = 10, hi.count = 50, suffix = "CHH_f")
...
diffMethData <- getMethylDiff(dmb_CHH, difference=5, qvalue=0.1)
...
act_diff_CHH = getMethylDiff(dmb_CHH, difference = 5, qvalue=0.99, type="all")
