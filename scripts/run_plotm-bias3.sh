...
# sbatch /uoa/home/s02df9/equina_meth_analysis/scripts/run_plotm-bias3.sh

cd /uoa/home/s02df9/equina_meth_analysis/'NEOF Methyl seq'/Trimmed/Sample_3-3_D
...
png(file = "pecent methylated by position per read 3.png")
read_meth_pc
dev.off()
quit(save = "no")
